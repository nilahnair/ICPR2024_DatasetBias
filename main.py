...
def configuration(dataset_idx, network_idx, output_idx, usage_modus_idx=0, dataset_fine_tuning_idx=0,
    ...
    if output[output_idx] == 'softmax':
        labeltype = "class"
        folder_exp = {'mocap': "/lara/results/exp32/cnntrans/",
                    'mbientlab': "/lara_imu/results/transt/",
                    'mobiact': "/mobiact/results/exp37/cnntrans/",
                    'motionsense': "//motionsense/results/exp5/cnntrans/",
                    'sisfall': "/sisfall/results/exp33/cnntrans/"
                    }
    elif output[output_idx] == 'attribute':
        labeltype = "attributes"
        folder_exp = "/results/all/"


    
    # Paths are given according to the ones created in *preprocessing.py for the datasets
    
    dataset_root = {'mocap': "/lara/prepros/exp32/",
                    'mbientlab': "/lara_imu/prepros/",
                    'mobiact': "/mobiact/prepros/exp37/",
                    'motionsense': "/motionsense/prepros/exp5/",
                    'sisfall': "/sisfall/prepros/exp33/"
                    }
