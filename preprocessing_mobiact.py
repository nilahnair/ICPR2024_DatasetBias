...
# folder path to the dataset. Ensure the readme file is present.
FOLDER_PATH = "path to dataset"
SUBJECT_INFO_FILE = '../MobiAct_Dataset/Readme.txt'

NUM_ACT_CLASSES=9 #activity classes
NUM_CLASSES=58 #subject classes
...
def generate_data(ids, sliding_window_length, sliding_window_step, base_directory=None,
    ...
    for act in activities:
        for sub in ids:
            ...
            '''split the obtained dataset accoridng to percentage. 
            here each individuals' recordings follow the split'''
...
def create_dataset(identity_bool = False):
    ...
    '''provide the list of train subjects here as given in the example. all the other subjects will
    be choosen for testing. Train and val subjects are the same. only part of the recordings are separated.'''
